...
to mitosis
  ask tumorcells[
    if fitness >= (precision(random-float mitosisProbability) 3) [
      ...
      let daughter2Karyotype (map [[a b] -> a + (b * -2)] chromosomes daughterKaryotype)
      hatch 1
      [
        set chromosomes daughter2Karyotype
        set-position
      ]
    ]
  ]
...
<experiments>
  ...
  <experiment name="2021-07-12_3000gens" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>file-open "/smph/users/arlynch2/Revisions/2021-06-28-ARL_segmental_aneuploidy_3000_gens_chromosome_output.csv"
...
file-close</final>
  ...
  <experiment name="2021-08-19" repetitions="8" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
  ...
  <experiment name="2021-08-20" repetitions="8" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
...
file-open "/smph/users/arlynch2/Revisions/2021-06-28-ARL_segmental_aneuploidy_3000_gensv2_chromosome_output.csv"
...
file-flush
  ...
  <experiment name="2022-10-04_short_broader_rate" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
  ...
  <experiment name="2023-01-12-ARL_1_Exp_Dip_Abun" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
    ...
    <steppedValueSet variable="pmisseg" first="0" step="0.001" last="1"/>
    <steppedValueSet variable="s" first="0" step="1" last="200"/>
    <enumeratedValueSet variable="initial-ploidy">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="end-ticks">
  ...
  <experiment name="2023-02-02-ARL_2_Exp_Dip_Driv" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
  ...
  <experiment name="2023-02-02-ARL_3_Exp_Dip_Hybr" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
  ...
  <experiment name="2023-02-02-ARL_4_Exp_Dip_Neut" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
  ...
  <experiment name="2023-03-06_RepExamples" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count tumorcells</metric>
    <metric>Chr1p</metric>
